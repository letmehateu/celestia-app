...
func initRootCommand(rootCommand *cobra.Command, capp *app.App) {
	...
	if err := addPreStartHooks(rootCommand, overrideLegacyBlockProp, overrideP2PConfig, checkBBR); err != nil {
...
func addStartFlags(startCmd *cobra.Command) {
	...
	startCmd.Flags().Bool(flagEnableLegacyBlockProp, false, "Enable legacy block propagation. When set, overrides consensus.enable_legacy_block_prop from config.toml")
}
